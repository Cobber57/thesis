...
def get_hop_location(prev_hop,hop,hop_details,ixp_entered_flag):
    ...
    # rule 5 if this ip address hasnt been picked up by any of the above rules then it probably just needs locating via its rdns
    ...
    # rule6 if ip address is part of an IXP then the facility needs to be worked out and then the coordinates of that facility
    elif ix_prefix_flag:
