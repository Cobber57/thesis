...
def get_hop_location(ixp_pre_hops,ixp_in_hops,ixp_post_hops,facilities_used,this_target,probe_id,prev_hop,hop,hop_details,ixp_entered_flag):
    ...
    for prefix in local_subnets:
        ...
        # TODO temporary fix as cant seem to get this working
    ...
    if not local_subnet_flag and not ix_prefix_flag and not target_flag and not gateway_flag:
        rule_flag = True
...
def main(argv):
    ...
    with open("results/"+in_file) as f:
