    ...
    if ix_prefix_flag:
        ...
        #print('FAC IS',this_fac)
            ...
            if rname.casefold() in results['failures']['rule5.fac_to_ip_table']:
                results['failures']['rule5.fac_to_ip_table'][rname.casefold()] +=1 
...
def main(argv):
    ...
    #results['failures']['rule5.reverse_tr'] = {}
    #results['failures']['rule5.reverse_tr']['total'] = 0
    #results['successes']['rule5.reverse_tr'] = {}
    #results['successes']['rule5.reverse_tr']['total'] = 0
